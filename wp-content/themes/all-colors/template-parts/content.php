	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'all-colors' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'all-colors' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
<?php endif; 
		...
		if ( 'post' === get_post_type() ) :
			...
			<div class="entry-meta">
				<?php
				all_colors_posted_on();
				all_colors_posted_by();
				?>
			</div><!-- .entry-meta -->
		<?php endif; ?>
	<footer class="entry-footer">
		<?php all_colors_entry_footer(); ?>
	</footer><!-- .entry-footer -->
